...
\paragraph{Code and data.} The code, the trained judge, every raw result and the research log will be released under Apache 2.0 at \url{https://github.com/Badtheorylabs/interference-search}.
